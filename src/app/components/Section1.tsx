...
import abs3d1 from "../../../public/images/blue-abstract.png";

const Section1 = () => {
  return (
    <main className="grid max-w-5xl relative w-full mx-auto lg:px-0 px-4 gap-6">
      <div className="flex flex-col h-[600px] relative rounded-[40px] w-full overflow-x-hidden bg-teal-300 place-content-center px-8 md:px-16 gap-4 text-black">
        <h2 className="text-5xl md:text-7xl md:w-2/3 font-bold">
          Welcome to the era of{" "}
          <span className="text-teal-700">mass electric mobility</span>
        </h2>
        <p className="md:w-1/2 w-full text-sm font-light">
          2023 was the year electric mobility entered the mainstream. Celebrate
